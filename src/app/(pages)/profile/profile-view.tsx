...
export const ProfileView: FC<ProfileViewProps> = ({ profile }) => {
   ...
   return (
      <div className="flex flex-col rounded-[10px] bg-card p-6">
         <div className="stone-pattern flex items-center justify-center rounded-md p-9 dark:bg-accent">
         ...
         <div className="mt-8 flex items-start">
            ...
            <div className="w-1/2 flex flex-col rounded-lg border-4 border-accent p-6">
         ...
         <div className="mt-8 grid grid-cols-3 gap-8">
            {profile?.items?.map((item, index) => (
               <Card key={index} item={item} hideButton={true} />
            ))}
         </div>
